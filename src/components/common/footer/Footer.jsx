...
const Footer = () => {
    return (
        <footer>
            <Layout>
                <div className='footer_contsiner'>
                    <div className='left'>
                        <ul>
                            <li><Link to="/">FIND A STORE</Link></li>
                            <li><Link to="/">BECOME A MEMBER</Link></li>
                            <li><Link to="/">Send Us Feedback</Link></li>
                            <li><Link to="/">STUDENT DISCOUNTS</Link></li>
                        </ul>
                        <ul>
                            <li><Link to="/">GET HELP</Link></li>
                            <li><Link to="/">Other Status</Link></li>
                            <li><Link to="/">Delivery</Link></li>
                            <li><Link to="/">Returns</Link></li>
                            <li><Link to="/">Payment Options</Link></li>
                            <li><Link to="/">Contact Us On Nike.com Inquiries</Link></li>
                            <li><Link to="/">Contact Us On All Other Inquiries</Link></li>
                        </ul>
                        <ul>
                ...
                <div className='copyright'>
                    ...
                    <ul className='right'>
                        ...
                        <li><Link to="/">Nike Privacy Policy</Link></li>
                    </ul>
                </div>
            </Layout>
        </footer>
